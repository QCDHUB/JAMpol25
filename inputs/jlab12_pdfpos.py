...
#---------------------------------------------------------------------------------------------------------------------------
conf['datasets']['pidis']['xlsx'][20005]='pidis/expdata/20005.xlsx' #  | JLab12    |          |
conf['datasets']['pidis']['xlsx'][20006]='pidis/expdata/20006.xlsx' #  | JLab12    |          |
#---------------------------------------------------------------------------------------------------------------------------
...
conf['steps'][istep]['datasets']['pidis'].append(20005) # JLab 12      |          |
conf['steps'][istep]['datasets']['pidis'].append(20006) # JLab 12      |          |
...
conf['FILT']['exp'].append(('pidis',20005,10))
conf['FILT']['exp'].append(('pidis',20006,10))
