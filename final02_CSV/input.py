...
conf['params']['ffpion']['db1 N'] ={'value':    2.67821e-02, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffpion']['db1 a'] ={'value':    1.76877e-01, 'min': -1.8 , 'max':    10,'fixed':False}
conf['params']['ffpion']['db1 b'] ={'value':    4.81521e+00, 'min':  0   , 'max':    30,'fixed':False}
conf['params']['ffpion']['db1 c'] ={'value':    4.81521e+00, 'min': -10  , 'max':    10,'fixed':False}
conf['params']['ffpion']['db1 d'] ={'value':    4.81521e+00, 'min': -10  , 'max':    10,'fixed':False}
...
conf['params']['ffpion']['db2 N'] ={'value':    0.00000e+00, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffpion']['db2 a'] ={'value':    1.76877e-01, 'min': -1.8 , 'max':    10,'fixed':False}
conf['params']['ffpion']['db2 b'] ={'value':    4.81521e+00, 'min':  0   , 'max':    30,'fixed':False}
conf['params']['ffpion']['db2 c'] ={'value':    4.81521e+00, 'min': -10  , 'max':    10,'fixed':False}
conf['params']['ffpion']['db2 d'] ={'value':    4.81521e+00, 'min': -10  , 'max':    10,'fixed':False}
