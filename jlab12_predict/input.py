...
#---------------------------------------------------------------------------------------------------------------------------
conf['datasets']['pidis']['xlsx'][20005]='pidis/expdata/20005.xlsx' #  | SANE    |          |
conf['datasets']['pidis']['xlsx'][20006]='pidis/expdata/20006.xlsx' #  | SANE    |          |
#---------------------------------------------------------------------------------------------------------------------------
...
conf['steps'][istep]['datasets']['pidis'].append(20005) # SANE      |          |
conf['steps'][istep]['datasets']['pidis'].append(20006) # SANE      |          |
